...
const loginUrl = "https://fortunadomein.b2clogin.com/<tenant id>/oauth2/v2.0/authorize";
const tokenUrl = "https://fortunadomein.b2clogin.com/common/oauth2/v2.0/token";
  ...
  _handleADToken(e: { url: string }): any {
    ...
    if (code !== null) {
      ...
      this._getResourceAccessToken(code).catch((err) => {
        log.error('ADLoginView._getResourceAccessToken', err.message)
      })
      return true
    }
