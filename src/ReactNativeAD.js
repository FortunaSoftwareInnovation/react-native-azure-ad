...
const defaultTokenUrl = "https://fortunadomein.b2clogin.com/fortunadomein.onmicrosoft.com/oauth2/v2.0/token?p=B2C_1_SignUp";

import type { ADConfig, ADCredentials, GrantTokenResp, ReactNativeADCredential } from './types';
